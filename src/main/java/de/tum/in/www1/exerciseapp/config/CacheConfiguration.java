...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cacheManager -> {
            ...
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.Participation.class.getName() + ".results", jcacheConfiguration);
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.Result.class.getName(), jcacheConfiguration);
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.Repository.class.getName(), jcacheConfiguration);
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.User.class.getName(), jcacheConfiguration);
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.Authority.class.getName(), jcacheConfiguration);
            cacheManager.createCache(de.tum.in.www1.exerciseapp.domain.User.class.getName() + ".authorities", jcacheConfiguration);
